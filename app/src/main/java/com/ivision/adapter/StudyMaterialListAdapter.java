...
import com.ivision.databinding.RecyclerviewStudyMaterialListItemBinding;
...
public class StudyMaterialListAdapter extends RecyclerView.Adapter implements Filterable {
    ...
    public StudyMaterialListAdapter(Context context, List<CommonModel> list, ClickListener listener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_TYPE_ITEM) {
            listHolder = new MyViewHolder(RecyclerviewStudyMaterialListItemBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
...
//                listener.onItemSelected(finalListHolder.getBindingAdapterPosition());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private RecyclerviewStudyMaterialListItemBinding binding;
        private ProgressbarBinding progressbarBinding;

        MyViewHolder(RecyclerviewStudyMaterialListItemBinding binding) {
