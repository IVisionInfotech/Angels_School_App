...
public class GalleryListAdapter extends RecyclerView.Adapter implements Filterable {
    ...
    public GalleryListAdapter(Context context, List<Gallery> list, ClickListener listener) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder.getItemViewType() == VIEW_TYPE_ITEM) {
            if (holder instanceof MyViewHolder) {
                ...
                mainHolder.binding.tvTitle.setText(model.getEvents());
//                mainHolder.binding.tvTitle.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
            }
        }
    }
