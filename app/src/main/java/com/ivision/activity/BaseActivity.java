...
//        Places.initialize(getApplicationContext(), getResources().getString(R.string.placeAPIKey));
    ...
    public void setCancelResultOfActivity(int resultCode, boolean finishStatus) {
        Intent intent = new Intent();
        setResult(resultCode, intent);
        intent.putExtra("result", resultCode);
    ...
    public void setCancelResultOfActivity(Intent intent, int resultCode, boolean finishStatus) {
        setResult(resultCode, intent);
        intent.putExtra("result", resultCode);
        setResult(Activity.RESULT_CANCELED, intent);
        if (finishStatus) finish();
