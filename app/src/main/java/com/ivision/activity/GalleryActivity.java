...
import com.ivision.adapter.GalleryListAdapter;
...
public class GalleryActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GalleryListAdapter(context, list, new ClickListener() {
            @Override
            public void onItemSelected(int position) {
                goToActivityForResult(new Intent(context, GalleryImageActivity.class).putExtra("id", list.get(position).getId()), new BaseActivity.OnActivityResultLauncher() {
                    @Override
...
//                getList(true);
    ...
    private void getList(boolean loadMore) {
        ...
        apiInterface.getList(Constant.galleryListUrl).enqueue(new Callback<JsonObject>() {
